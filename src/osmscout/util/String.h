...
extern size_t CountWords(const std::string& text);

/**
 * \ingroup Util
 * Converts the given string into a list of whitespace separated (std::isspace()) strings.
 */
extern std::list<std::string> SplitStringAtSpace(const std::string& input);
 ...
 */
extern std::list<std::string> SplitString(const std::string& stringList,
 ...
 */
extern std::string GetFirstInStringList(const std::string& stringList,
 ...
 */
extern void TokenizeString(const std::string& input,
 ...
 * case letter.
 */
extern void SimplifyTokenList(std::list<std::string>& tokens);

extern std::string GetTokensFromStart(const std::list<std::string>& tokens,
                                                  size_t count);

extern std::string GetTokensFromEnd(const std::list<std::string>& tokens,
                                                 size_t count);
 ...
 */
extern void GroupStringListToStrings(std::list<std::string>::const_iterator token,
                                                  size_t listSize,
                                                  size_t parts,
 ...
 */
extern std::wstring LocaleStringToWString(const std::string& text);
 ...
 */
extern std::string WStringToLocaleString(const std::wstring& text);
 ...
 *    corresponding std::wstring
 */
extern std::u32string UTF8StringToU32String(const std::string& text);
 ...
 */
extern std::string WStringToUTF8String(const std::wstring& text);
 ...
 *    the converted std::string
 */
extern std::string LocaleStringToUTF8String(const std::string& text);
 ...
 *    the converted std::string
 */
extern std::string UTF8StringToLocaleString(const std::string& text);
 ...
 *
 */
extern std::string UTF8StringToUpper(const std::string& text);
 ...
 *
 */
extern std::string UTF8StringToLower(const std::string& text);
 ...
 *    Converted text
 */
extern std::string UTF8NormForLookup(const std::string& text);
 ...
 */
extern bool ParseISO8601TimeString(const std::string &timeStr, Timestamp &timestamp);
 ...
 * @return time string
 */
extern std::string TimestampToISO8601TimeString(const Timestamp &timestamp);

extern std::string DurationString(const Duration &duration);
}